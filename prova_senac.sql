CREATE DATABASE diariodebordo; #Aqui esta sendo criado nosso banco de dados
USE diariodebordo; #Aqui esta um comando para usar o nosso banco de dados 
-- Criar nossa tabela #Aqui sera criado nossa tabela "ALUNO"
CREATE TABLE aluno(   
...
describe aluno; #Aqui sera mostrados as infomracoes da tabela
...
#Estes 3 comandos serve para ver todos eles no banco
SELECT * FROM aluno;
...
SELECT * FROM aluno 
         ...
         -- George Boole
         -- Tabela Verdade
show tables; #Aqui mostrara todas as tabelas
#Aqui sera criada nossa tabela Diario de Bordo
...
describe diariobordo; #Aqui sera mostrados as infomracoes da tabela
show tables;#Aqui mostrara todas as tabelas
...
describe diariobordo;#Aqui sera mostrados as infomracoes da tabela
 ...
 #Estes 2 comandos serve para ver todos eles no banco   
...
('O debate em sala foi muito enriquecedor de informacoes importantes para o nosso conhimento.', '2024-08-08 21:45:00', 14),
